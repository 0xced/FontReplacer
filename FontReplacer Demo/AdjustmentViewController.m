...
@synthesize factorSlider = m_factorSlider;
...
- (void) reloadData
{
	self.font1NormalLabel.font = [UIFont fontWithName:@"CaviarDreams" size:floorf(self.pointSizeSlider.value)];
	self.font1ItalicLabel.font = [UIFont fontWithName:@"CaviarDreams-Italic" size:floorf(self.pointSizeSlider.value)];
	self.font1BoldLabel.font = [UIFont fontWithName:@"CaviarDreams-Bold" size:floorf(self.pointSizeSlider.value)];
	self.font1BoldItalicLabel.font = [UIFont fontWithName:@"CaviarDreams-BoldItalic" size:floorf(self.pointSizeSlider.value)];	
